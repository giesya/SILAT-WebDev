...
const SAMPLE_PPP_SIPR = [
  { id: 'PPP-2026-001', company: 'PT Laut Nusantara', billType: 'SPP-PPP (Praproduksi)', amount: 'Rp 185.000.000', stage: 'Sub Timja', date: '12 Jan 2026' },
  { id: 'SIPR-2026-002', company: 'CV Samudra Jaya', billType: 'SIPR (Izin Rumpon)', amount: 'Rp 25.000.000', stage: 'Katimja', date: '15 Jan 2026' },
  { id: 'PPP-2026-003', company: 'PT Bahari Maju', billType: 'SPP-PPP (Praproduksi)', amount: 'Rp 94.000.000', stage: 'Approved', date: '20 Jan 2026' },
]

export default function ApprovalSPPPPSIPR({ onLogout }) {
  const [activeTab, setActiveTab] = useState('Sub Timja')
  const [searchQuery, setSearchQuery] = useState('')
  const [data, setData] = useState(SAMPLE_PPP_SIPR)
  ...
  const breadcrumbs = [
    { label: 'Approval' },
    { label: 'Approval SPP–PPP & SIPR' },
  ]

  return (
    <Layout
      currentPath="/approval/spp-ppp-sipr"
      onLogout={onLogout}
      breadcrumbs={breadcrumbs}
      eyebrow="Approval Pungutan Praproduksi"
      title="Approval SPP–PPP & SIPR"
      subtitle="Verifikasi bertingkat penghitungan PNBP Pungutan Pengusahaan Perikanan (PPP) dan izin pemasangan rumpon."
    >
      {toast && (
          ...
          <table className="w-full text-left text-sm border-collapse min-w-[700px]">
            <thead>
              <tr className="bg-[var(--color-primary)] text-white text-xs uppercase tracking-wider">
                ...
                <th className="px-5 py-3.5 font-bold">Kategori Tagihan</th>
