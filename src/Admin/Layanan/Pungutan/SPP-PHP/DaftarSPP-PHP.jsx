...
const SAMPLE_DAFTAR_SPP_PHP = [
  {
    id: 'SPP-PHP-2026-0012',
...
export default function DaftarSPPPHP({ onLogout }) {
  ...
  const filteredData = useMemo(() => {
    ...
    if (!q) return SAMPLE_DAFTAR_SPP_PHP
    return SAMPLE_DAFTAR_SPP_PHP.filter((item) =>
  ...
  const breadcrumbs = [
    ...
    { label: 'Pungutan' },
    { label: 'SPP–PHP' },
    { label: 'Daftar SPP–PHP' },
  ]

  return (
    <Layout
      currentPath="/layanan/pungutan/spp-php/daftar-spp-php"
      onLogout={onLogout}
      breadcrumbs={breadcrumbs}
      title="Daftar SPP–PHP"
    >
      {/* Search Bar Section */}
      <section className="bg-white rounded-2xl border border-[rgba(31,78,120,0.08)] p-6 shadow-xs mb-8">
        <h2 className="text-base font-bold text-[var(--color-text)] mb-3">Pencarian Daftar Tagihan SPP–PHP</h2>
                ...
                <tr key={item.id} className="hover:bg-[rgba(0,90,156,0.03)] transition-colors">
                  ...
                  <td className="px-5 py-4 text-center whitespace-nowrap">
                    <button
                      ...
                      title="Lihat Rincian Surat Tagihan SPP"
                    >
          ...
          >
            ...
            <div className="space-y-3 text-xs text-slate-700">
              ...
              <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-xl space-y-2">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-emerald-800 font-bold">Nominal Tagihan (PHP):</span>
