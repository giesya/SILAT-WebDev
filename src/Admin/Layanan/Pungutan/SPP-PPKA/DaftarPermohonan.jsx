...
export default function SPPPPKADaftarPermohonan({ onLogout }) {
  ...
  const filteredData = useMemo(() => {
    ...
    if (!q) return SAMPLE_PERMOHONAN_PPKA
    return SAMPLE_PERMOHONAN_PPKA.filter((item) =>
  ...
  return (
    <Layout
      currentPath="/layanan/pungutan/spp-ppka/daftar-permohonan"
      onLogout={onLogout}
      breadcrumbs={breadcrumbs}
      title="Daftar Permohonan SPP–PPKA"
    >
      {/* Search Bar Section */}
      <section className="bg-white rounded-2xl border border-[rgba(31,78,120,0.08)] p-6 shadow-xs mb-8">
        <h2 className="text-base font-bold text-[var(--color-text)] mb-3">Pencarian Permohonan SPP–PPKA</h2>
      ...
      <section className="bg-white rounded-2xl border border-[rgba(31,78,120,0.08)] shadow-xs overflow-hidden mb-8">
        ...
        {sortedData.length === 0 ? (
          <div className="p-12 text-center text-sm text-[var(--color-muted)]">
            Data permohonan SPP–PPKA tidak ditemukan.
          </div>
        ) : (
          <Pagination
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold text-base text-[var(--color-text)]">
                    Rincian Surat Tagihan SPP–PPKA
                  </h3>
            ...
            <div className="space-y-3 text-xs text-slate-700">
              <div className="p-4 bg-[var(--color-bg)] rounded-xl space-y-2.5">
                <div className="flex justify-between">
                  <span className="text-slate-500">Agen / Pemilik:</span>
                  <span className="font-bold text-slate-800">{selectedSPP.owner}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Kapal Asing & GT:</span>
              ...
              <div className="p-4 bg-emerald-50/70 border border-emerald-200 rounded-xl space-y-2">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-emerald-800 font-bold">Nominal Tarif (PPKA Kapal Asing):</span>
